...
hal_arch_default_isr(CYG_ADDRWORD vector, CYG_ADDRWORD data)
{
    ...
    diag_printf("hal_arch_default_isr- Interrupt: %d\n", vector);
...
// Debug routines
extern void cyg_hg_trace_dump(void);
...
#ifdef CYGDBG_HG_DUMP_ALL_THREADS_INFO
    cyg_hg_dump_frame((unsigned char *)frame, ERR_UNDEF_INT);
    cyg_hg_trace_dump();
#else
    dump_frame((unsigned char *)frame);
#endif
...
#ifdef CYGDBG_HG_DUMP_ALL_THREADS_INFO
    cyg_hg_dump_frame((unsigned char *)frame, ERR_SOFT_INT);
    cyg_hg_trace_dump();
#else
    dump_frame((unsigned char *)frame);
#endif
...
#ifdef CYGDBG_HG_DUMP_ALL_THREADS_INFO
    cyg_hg_dump_frame((unsigned char *)frame, ERR_PREFETCH);
    cyg_hg_trace_dump();
#else
    dump_frame((unsigned char *)frame);
#endif
...
#ifdef CYGDBG_HG_DUMP_ALL_THREADS_INFO
    cyg_hg_dump_frame((unsigned char *)frame, ERR_DATA_ABORT);
    cyg_hg_trace_dump();
#else
    dump_frame((unsigned char *)frame);
#endif
...
#ifdef CYGDBG_HG_DUMP_ALL_THREADS_INFO
    cyg_hg_dump_frame((unsigned char *)frame, 0);
    cyg_hg_trace_dump();
#else
    dump_frame((unsigned char *)frame);
#endif
