...
extern int qspi_read_page_data(cyg_uint8 cmd, cyg_uint32 addr, cyg_uint8 *rx_dbuf, int rx_len, int dfs);
...
static void qspi_gd25q256d_write_extend_addr(cyg_uint8 cmd, cyg_uint8 data)
{
...
static cyg_uint8 qspi_gd25q256d_write_status(cyg_uint8 cmd, cyg_uint8 sr_x)
{
	int ret=0;
...
static void qspi_gd25q256d_4byte_extend_enable(cyg_uint32 addr)
{
#ifdef QSPI_DEBUG
...
static void qspi_gd25q256d_4byte_extend_disable(cyg_uint32 addr)
{
#ifdef QSPI_DEBUG
    unsigned long long s, e;
    cyg_uint32 us;
