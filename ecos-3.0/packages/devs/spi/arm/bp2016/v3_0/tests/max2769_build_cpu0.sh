...
TARGET_BASE="bp2016_spi_max2769_test"
TARGET_BIN="$TARGET_BASE.bin"
TARGET_ELF="$TARGET_BASE.elf"
TARGET_LST="$TARGET_BASE.lst"

arm-eabi-gcc -g -o $TARGET_ELF bp2016_spi_max2769_test.c spi_max2769_config.c -I ./install/include/ -L ./install/lib/ -T target.ld -nostdlib
