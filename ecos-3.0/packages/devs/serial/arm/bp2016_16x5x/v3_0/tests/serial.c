...
serial_test1( void )
{
    ...
    char long_msg[] = "test1--This is a longer message \r\n";
    char filler[] = "          \r\n";
...
hang();
    ...
    for (i = 0;  i < 10;  i++) {
        ...
        if (res != ENOERR) {
            ...
            diag_printf("write [short] data - loop: %d\n", i);
    }
    for (i = 0;  i < 10;  i++) {
        len = (i % 10) + 1;
            diag_printf("loop: %d, filler len:%d\n", i, len);
        cyg_io_write(handle, filler, &len);
        len = strlen(long_msg);
            diag_printf("loop: %d, long_msg len:%d\n", i, len);
        ...
        if (res != ENOERR) {
            ...
            diag_printf("write [long] data - loop: %d\n", i);
    }
    len = strlen(prompt);
    ...
    if (res != ENOERR) {
        diag_printf("Can't read enough data - DEVIO error: %d\n", res);
