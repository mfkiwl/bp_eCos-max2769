/*
 *  linux/lib/vsprintf_self.c
 *
 *  Copyright (C) 1991, 1992  Linus Torvalds
 */

/* vsprintf_self.c -- Lars Wirzenius & Linus Torvalds. */
/*
...
extern int uart_puts(char * info);
...
#define vscnprintf(buf, size, fmt, args...) vsprintf_self(buf, fmt, ##args)
