...
__externC int cyg_flash_erase(cyg_flashaddr_t flash_base, 
                              ...
                              cyg_flashaddr_t *err_address);
// wwzz add 20181024
__externC int cyg_flash_chip_erase(cyg_flashaddr_t flash_base);
__externC size_t cyg_flash_read_id(const cyg_flashaddr_t flash_base);
__externC int cyg_flash_program(cyg_flashaddr_t flash_base, 
                                const void *ram_base, 
                                size_t len, 
                                cyg_flashaddr_t *err_address);
__externC int cyg_flash_scan(cyg_flash_printf *pf);
...
__externC int cyg_flash_region_lock(cyg_flashaddr_t flash_base, cyg_uint32 region);
__externC int cyg_flash_region_unlock(cyg_flashaddr_t flash_base, cyg_uint32 region);
__externC int cyg_flash_global_lock(cyg_flashaddr_t flash_base);
__externC int cyg_flash_global_unlock(cyg_flashaddr_t flash_base);
#endif
