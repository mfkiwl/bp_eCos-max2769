...
protected:
    ...
    /* wujy add  begin*/
    HAL_SavedRegisters  *hg_saved_context; // If non-zero, this points at a more
                                        // interesting context than stack_ptr.
    /* wujy add  end*/
#endif
...
#ifdef CYGDBG_HG_DUMP_ALL_THREADS_INFO
    /* wujy add  begin*/
    HAL_SavedRegisters *hg_get_saved_context();

    // Set the saved context pointer.
    void hg_set_saved_context(HAL_SavedRegisters *ctx);
    /* wujy add  end*/
#endif
};
...
public:
    ...
    // wwzz add for cpuload cal 20190307
