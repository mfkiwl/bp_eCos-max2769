...
# define CYG_HARDWARETHREAD_HG_SAVED_CONTEXT_MEMBER \
    void                *hg_saved_context; // If non-zero, this points at a more
                                        // interesting context than stack_ptr.
#else
# define CYG_HARDWARETHREAD_HG_SAVED_CONTEXT_MEMBER
#endif
...
#define CYG_HARDWARETHREAD_MEMBERS                                           \
    ...
    CYG_HARDWARETHREAD_HG_SAVED_CONTEXT_MEMBER
...
# define CYGFUN_KERNEL_THREADS_CPULOAD_MEMBER \
    cyg_uint64 tick_start;\
    cyg_uint64 tick_total;
#else
# define CYGFUN_KERNEL_THREADS_CPULOAD_MEMBER 
#endif
...
#define CYG_THREAD_MEMBERS                        \
    ...
    CYGFUN_KERNEL_THREADS_CPULOAD_MEMBER 
