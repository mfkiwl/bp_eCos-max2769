...
#define DMAC_REG_READ(reg)                 REG_READ_UINT32((HW_DMAC_CONTROLLER_BASE + (reg)))
#define DMAC_REG_WRITE(reg, value)         REG_WRITE_UINT32((HW_DMAC_CONTROLLER_BASE + (reg)), (value))

#define HW_DMAC_CH(channel_id)        ((DMAC_CH_CONTROLLER_ST *)(HW_DMAC_CONTROLLER_BASE + HW_DMAC_CONTROLLER_CH_BASE \
                                             + (channel_id) * HW_DMAC_CONTROLLER_INTERVAL))
#define SYS_IRQ_ID_DMA0                    SYS_IRQ_ID_DMAC0
...
#define HW_DMAC_CH_INTCLEAR_REG_OFFSET     (0x98)
...
#define DMAC_CH_INTSTATUS_ENABLE_DMA_TFR_DONE_BIT     (DMAC_CH_INT_TYPE_E_DMA_TFR_DONE)
#define DMAC_CH_INTSTATUS_ENABLE_DMA_TFR_DONE_MASK    (0x1 << DMAC_CH_INTSTATUS_ENABLE_DMA_TFR_DONE_BIT)

#define DMAC_CH_INTSTATUS_ENABLE_BLK_TFR_DONE_BIT     (DMAC_CH_INT_TYPE_E_BLK_TFR_DONE)
#define DMAC_CH_INTSTATUS_ENABLE_BLK_TFR_DONE_MASK    (0x1 << DMAC_CH_INTSTATUS_ENABLE_BLK_TFR_DONE_BIT)

#define DMAC_CH_INTSTATUS_ENABLE_SHADOWREG_OR_LLI_INVALID_ERR_BIT     (DMAC_CH_INT_TYPE_E_SHADOWREG_OR_LLI_INVALID_ERR)
...
// CHx_INTSTATUS_REG
#define DMAC_CH_INTSTATUS_DMA_TFR_DONE_BIT            (DMAC_CH_INT_TYPE_E_DMA_TFR_DONE)
#define DMAC_CH_INTSTATUS_DMA_TFR_DONE_MASK           (0x1 << DMAC_CH_INTSTATUS_DMA_TFR_DONE_BIT)

#define DMAC_CH_INTSTATUS_BLK_TFR_DONE_BIT            (DMAC_CH_INT_TYPE_E_BLK_TFR_DONE)
#define DMAC_CH_INTSTATUS_BLK_TFR_DONE_MASK           (0x1 << DMAC_CH_INTSTATUS_BLK_TFR_DONE_BIT)

#define DMAC_CH_INTSTATUS_SHADOWREG_OR_LLI_INVALID_ERR_BIT            (DMAC_CH_INT_TYPE_E_SHADOWREG_OR_LLI_INVALID_ERR)
...
#define DMAC_CH_INTSIGNAL_ENABLE_DMA_TFR_DONE_BIT     (DMAC_CH_INT_TYPE_E_DMA_TFR_DONE)
#define DMAC_CH_INTSIGNAL_ENABLE_DMA_TFR_DONE_MASK    (0x1 << DMAC_CH_INTSIGNAL_ENABLE_DMA_TFR_DONE_BIT)

#define DMAC_CH_INTSIGNAL_ENABLE_BLK_TFR_DONE_BIT     (DMAC_CH_INT_TYPE_E_BLK_TFR_DONE)
#define DMAC_CH_INTSIGNAL_ENABLE_BLK_TFR_DONE_MASK    (0x1 << DMAC_CH_INTSIGNAL_ENABLE_BLK_TFR_DONE_BIT)

#define DMAC_CH_INTSIGNAL_ENABLE_SHADOWREG_OR_LLI_INVALID_ERR_BIT     (DMAC_CH_INT_TYPE_E_SHADOWREG_OR_LLI_INVALID_ERR)
...
// CHx_INTCLEARREG
#define DMAC_CH_INTCLEAR_DMA_TFR_DONE_BIT             (DMAC_CH_INT_TYPE_E_DMA_TFR_DONE)
#define DMAC_CH_INTCLEAR_DMA_TFR_DONE_MASK            (0x1 << DMAC_CH_INTCLEAR_DMA_TFR_DONE_BIT)

#define DMAC_CH_INTCLEAR_BLK_TFR_DONE_BIT             (DMAC_CH_INT_TYPE_E_BLK_TFR_DONE)
#define DMAC_CH_INTCLEAR_BLK_TFR_DONE_MASK            (0x1 << DMAC_CH_INTCLEAR_BLK_TFR_DONE_BIT)

#define DMAC_CH_INTCLEAR_SHADOWREG_OR_LLI_INVALID_ERR_BIT             (DMAC_CH_INT_TYPE_E_SHADOWREG_OR_LLI_INVALID_ERR)
