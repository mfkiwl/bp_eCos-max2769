...
#define CYGNUM_KERNEL_COUNTERS_CLOCK_ISR_PRIORITY 160
#define CYGNUM_KERNEL_COUNTERS_CLOCK_ISR_PRIORITY_160
...
#define CYGNUM_KERNEL_SYNCH_MBOX_QUEUE_SIZE 128
#define CYGNUM_KERNEL_SYNCH_MBOX_QUEUE_SIZE_128
